...
async function loadUsersOfSite(siteId) {
  users.value = [];
  const res = await fetch(`https://doldariback-production.up.railway.app/api/location/sites/${siteId}/users`, {
    method: "GET",
    headers: { Accept: "application/json" },
    credentials: "include",
  });
...
async function addRegion() {
  ...
  const res = await fetch("https://doldariback-production.up.railway.app/api/location/regions", {
    method: "POST",
...
async function addSite() {
  ...
  const res = await fetch("https://doldariback-production.up.railway.app/api/location/sites", {
    method: "POST",
    headers: { "Content-Type": "application/json", Accept: "application/json" },
    credentials: "include",
...
async function addUser() {
  ...
  const res = await fetch("https://doldariback-production.up.railway.app/api/location/users", {
    method: "POST",
    headers: { "Content-Type": "application/json", Accept: "application/json" },
    credentials: "include",
    body: JSON.stringify({
...
async function deleteSelected() {
  try {
    if (selectedUser.value) {
      const res = await fetch(`https://doldariback-production.up.railway.app/api/location/users/${selectedUser.value.id}`, {
        method: "DELETE",
        headers: { Accept: "application/json" },
        credentials: "include",
      });
    ...
    if (selectedSite.value) {
      const res = await fetch(`https://doldariback-production.up.railway.app/api/location/sites/${selectedSite.value.id}`, {
        method: "DELETE",
        headers: { Accept: "application/json" },
        credentials: "include",
      });
    ...
    if (selectedRegion.value) {
      const res = await fetch(`https://doldariback-production.up.railway.app/api/location/regions/${selectedRegion.value.id}`, {
        method: "DELETE",
        headers: { Accept: "application/json" },
        credentials: "include",
      });
